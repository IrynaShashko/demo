      ...
      <HomeContainer>
        <Container>
          <TextContainer>
            <PhoneButton />
            <Text>
              Ласкаво просимо у світ розслаблення та відновлення гармонії!{" "}
              <br /> Тут ви зможете знайти різноманітні види масажу, які
              допоможуть вам зняти напругу, покращити кровообіг та позбутися від
              стресу.
            </Text>
            <ButtonContainer>
