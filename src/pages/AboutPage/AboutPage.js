        ...
        <StudyContainer>
          ...
          <Container>
            <TitleText>
              ...
              <br /> Мене звати Марія Глушенко, і я є сертифікованим фахівцем з
              багаторічним досвідом. <br />
              Моя мета - не просто зняти фізичний дискомфорт, а й створити
              глибокий зв'язок між вашим тілом та розумом. Масаж - це не тільки
              про розслаблення м'язів, а й про відновлення внутрішньої гармонії.
              <br />У своїй роботі я використовую натуральні олії та аромати,
              які підсилюють ефект масажу і допомагають вам зануритися у
              атмосферу спокою та розслаблення. <br />
              Запрошую вас на сесію масажу, де вас оточить увага, турбота та
              професійний підхід. Дозвольте собі на мить відірватися від
              щоденних турбот та дати своєму тілу заслужений відпочинок. <br />
