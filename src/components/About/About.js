      ...
      >
        <InfoItem variants={animationElement} custom={2}>
          ...
          <MainText>
            ...
            історію, яку розповідає тіло. Ваша довіра - моя найбільша нагорода,
            моя відданість. Ваша рекомендація друзям, рідним, близьким людям
            дарує відчуття, що я на своєму місці.
          </MainText>
        </InfoItem>
        <InfoItem variants={animationElement} custom={4}>
          ...
          <MainText>
            Мій підхід до масажу - це справжній симбіоз різноманітних технік та
            методик, які я вдосконалювала протягом багатьох років. Кожна сесія -
            це унікальна подорож, де я поєдную різні прийоми для досягнення
            максимального результату. Від класичного масажу до глибокотканного,
            від релаксуючих аромамасажів до точкового впливу на активні точки,
            акупресурою та сухою голкою - моя задача підібрати те, що тут і
            зараз відповідає вашим потребам та здоров'ю вашого тіла.
          </MainText>
        </InfoItem>
        <InfoItem variants={animationElement} custom={6}>
          ...
          <MainText>
            ...
            духовного стану. Кожний сеанс неповторний, кожний рух наповнить з
            середини.
          </MainText>
        </InfoItem>
      </InfoContainer>
